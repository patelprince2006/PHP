...
// Swaps the values between From and To inputs for Flight Search
function swapLocations() {
    const from = document.querySelector('select[name="departure_city"]');
    const to = document.querySelector('select[name="arrival_city"]');
    if(from && to) {
...
// Swaps the values between From and To inputs for Bus Search
